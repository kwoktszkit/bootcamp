...
public interface DataOperation {
  ...
  @Operation(summary = "Get All Stock Profiles", description = "This endpoint is to get all Company Profile from database", tags = "Find All Stock Profiles")
  @ApiResponses({
  ...
  @Operation(summary = "Get Stock List By Country and Market Cap", description = "This endpoint is to insert stock data into database", tags = "Get Stock List")
  @ApiResponses({
      @ApiResponse(responseCode = "200", content = {
          @Content(schema = @Schema(implementation = Stock.class), mediaType = "application/json") }),
      @ApiResponse(responseCode = "404", content = { @Content(schema = @Schema()) }),
